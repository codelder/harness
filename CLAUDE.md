...
A high-performance, memory-safe AI agent harness built in Rust. The project re-implements the 12-session curriculum from [learn-claude-code](https://github.com/shareAI-lab/learn-claude-code), transforming the Python reference into a production-ready Rust CLI tool.
...
- `HARNESS_ANTHROPIC_URL` — Anthropic base URL (optional, for proxies)
- `HARNESS_OPENAI_KEY` — OpenAI API key
- `HARNESS_OPENAI_URL` — OpenAI base URL (optional, for proxies)
